...
sidebar:
  bg_image: https://cdn.yunyoujun.cn/img/bg/alpha-stars-timing-1.webp
  # dark_bg_image: https://cdn.yunyoujun.cn/img/bg/dark-alpha-stars-timing-1.webp
...
# -------
# friend
anonymous_image: https://cdn.yunyoujun.cn/img/avatar/none.jpg
...
cdn:
  ...
  css:
    yun-markdown-css: "yun_markdown_css"
    prism-theme-vars: "prism_theme_vars"
  js:
    base:
    async:
    defer:
...
bg_image:
  enable: true
  url: https://cdn.yunyoujun.cn/img/bg/stars-timing-0-blur-30px.jpg # recomend image related to your mode
...
search:
  modal: true
  bg_image: https://cdn.yunyoujun.cn/img/bg/stars-timing-0-blur-30px.jpg
  dark_bg_image: https://cdn.yunyoujun.cn/img/bg/mountain-blur-30px.jpg
  # placeholder: 想要搜些什么？
...
aplayer:
  ...
  widget:
    ...
    audio:
      - name: 星宿计时
        artist: 杉田朗/洛天依
        url: https://cdn.yunyoujun.cn/audio/star-timer.mp3
